            ...
            <ul className="navbar-nav navbar-vertical ms-xl-4 d-none d-xl-flex">
              <li className="nav-item dropdown">
                ...
                <li className="dropdown-item dropright">
                      <Link to="/Allcourses" className="dropdown-link dropdown-toggle">
          ...
          <div className="container">
            <div className="row align-items-center mb-5" data-aos="fade-up">
              ...
              <div className="col-md-auto">
                <select className="ipnSec form-select form-select-sm text-primary fw-medium shadow" data-choices>
              ...
              <div className="col-12 col-md-6 col-xl-4 pb-4 pb-md-7" data-aos="fade-up" data-aos-delay={50} style={{paddingRight: '15px', paddingLeft: '15px'}}>
                ...
                <div className="card border shadow p-2 sk-fade">
                  ...
                  <div className="card-zoom position-relative">
                    ...
                    <Link to="/CourseSingle" className="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 me-1 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36" >
                        {/* Icon */}
                  ...
                  <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                    ...
                    {/* Preheading */}
                    <Link to="/CourseSingle"><span className="mb-1 d-inline-block text-gray-800">Photography</span></Link>
                    {/* Heading */}
                    <div className="position-relative">
                    <Link to="/CourseSingle" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Fashion Photography From Professional</h4></Link>
              ...
              <div className="col-md mb-5 mb-lg-0">
                ...
                <div className="card border shadow p-2 lift sk-fade">
                  ...
                  <Link to="/CourseSingle" className="card-img d-block sk-thumbnail img-ratio-3">
                      <img className="rounded shadow-light-lg img-fluid" src="../assets/img/post/post-1.jpg" alt="..." />
                      </Link>
                  ...
                  <div className="card-footer px-2 pb-0 pt-4">
                    ...
                    {/* Heading */}
                    <div className="d-block"><h5 className="line-clamp-2 h-48 h-lg-52">The Best Destinations to Begin Your Round the World Trip</h5></div>
                  </div>
                </div>
              </div>
              <div className="col-md mb-5 mb-lg-0">
                ...
                <div className="card border shadow p-2 lift sk-fade">
                  ...
                  <div className="card-zoom position-relative">
                  <Link to="/CourseSingle" className="card-img d-block sk-thumbnail img-ratio-3">
                      <img className="rounded shadow-light-lg img-fluid" src="../assets/img/post/post-2.jpg" alt="..." />
                      </Link>
                      <Link to="/CourseSingle" className="badge sk-fade-bottom badge-lg badge-purple badge-pill badge-float bottom-0 left-0 mb-4 ms-4 px-5 me-4">
                  ...
                  <div className="card-footer px-2 pb-0 pt-4">
                    ...
                    {/* Heading */}
                    <div className="d-block"><h5 className="line-clamp-2 h-48 h-lg-52">An Indigenous Anatolian Syllabic Script From 3500 Years Ago</h5></div>
                  </div>
                </div>
              </div>
              <div className="col-md mb-5 mb-lg-0">
                ...
                <div className="card border shadow p-2 lift sk-fade">
                  ...
                  <div className="card-zoom position-relative">
                  <Link to="/CourseSingle" className="card-img d-block sk-thumbnail img-ratio-3">
                    <img className="rounded shadow-light-lg img-fluid" src="../assets/img/post/post-3.jpg" alt="..." />
                    </Link>
                    <Link to="/CourseSingle" className="badge badge-lg sk-fade-bottom badge-purple badge-pill badge-float bottom-0 left-0 mb-4 ms-4 px-5 me-4">
                  ...
                  <div className="card-footer px-2 pb-0 pt-4">
                    ...
                    {/* Heading */}
                    <div className="d-block"><h5 className="line-clamp-2 h-48 h-lg-52">10 Best Countries to Visit for Beginner Travelers</h5></div>
                  </div>
                </div>
              </div>
            </div>
