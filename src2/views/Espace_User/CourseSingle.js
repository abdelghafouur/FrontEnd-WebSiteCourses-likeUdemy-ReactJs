  ...
  return (
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-lg-6 mb-5 mb-lg-0 position-relative">
                      ...
                      <p className="me-xl-8 mb-5 text-white">Master Figma app to get a job in UI Design, User Interface, User Experience design, Web Design &amp; UX design.</p>
                      ...
                      <div className="d-md-flex align-items-center mb-6">
                        ...
                        <div className="ms-md-6">
                          <div className="mb-2 d-flex align-items-center">
                            ...
                            <a href="#" className="font-size-sm text-white ms-3">Alison Dawn</a>
                          </div>
                          <div className="mb-2 d-flex align-items-center">
                            <h6 className="mb-0 text-white font-size-sm">Categories</h6>
                            <a href="#" className="font-size-sm text-white ms-3">Design</a>
                          </div>
                          <div className="mb-2 d-flex align-items-center">
                      ...
                      <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item d-flex align-items-center py-3 text-white bg-transparent border-white-10">
                          ...
                          <h6 className="mb-0 ms-3 me-auto text-white">Enrolled</h6>
                        ...
                        <li className="list-group-item d-flex align-items-center py-3 text-white bg-transparent border-white-10">
                          ...
                          <h6 className="mb-0 ms-3 me-auto text-white">Skill level</h6>
                          <span>beginner</span>
                        </li>
                        <li className="list-group-item d-flex align-items-center py-3 text-white bg-transparent border-white-10">
                          <div className="text-white d-flex icon-uxs">
                        ...
                        <li className="list-group-item d-flex align-items-center py-4 bg-transparent border-white-10">
                          <a href="#" className="mx-auto text-white fw-medium d-flex align-items-center mt-2">
                            {/* Icon */}
                            <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      >
          ...
          <div className="d-flex align-items-center mb-2"> 
                        <ins className="h2 mb-0 text-white">$89.99</ins>
                        ...
                        <div className="col-md">
                          <div className="d-md-flex align-items-center my-3 my-md-4">
                            <div className="bg-gray-200 position-relative rounded-pill flex-grow-1 me-md-5 mb-2 mb-md-0 mw-md-260p" style={{height: '10px'}}>
                              <div className="bg-teal rounded-pill position-absolute top-0 left-0 bottom-0" style={{width: '90%'}} />
                            </div>
                            <div className="d-flex align-items-center">
                          ...
                          <div className="d-md-flex align-items-center my-3 my-md-4">
                            <div className="bg-gray-200 position-relative rounded-pill flex-grow-1 me-md-5 mb-2 mb-md-0 mw-md-260p" style={{height: '10px'}}>
                              <div className="bg-teal rounded-pill position-absolute top-0 left-0 bottom-0" style={{width: '60%'}} />
                            </div>
                            <div className="d-flex align-items-center">
                              <div className="star-rating star-rating-lg secondary me-4">
                          ...
                          <div className="d-md-flex align-items-center my-3 my-md-4">
                            <div className="bg-gray-200 position-relative rounded-pill flex-grow-1 me-md-5 mb-2 mb-md-0 mw-md-260p" style={{height: '10px'}}>
                              <div className="bg-teal rounded-pill position-absolute top-0 left-0 bottom-0" style={{width: '50%'}} />
                            </div>
                            <div className="d-flex align-items-center">
                              <div className="star-rating star-rating-lg secondary me-4">
                          ...
                          <div className="d-md-flex align-items-center my-3 my-md-4">
                            <div className="bg-gray-200 position-relative rounded-pill flex-grow-1 me-md-5 mb-2 mb-md-0 mw-md-260p" style={{height: '10px'}}>
                              <div className="bg-teal rounded-pill position-absolute top-0 left-0 bottom-0" style={{width: '35%'}} />
                            </div>
                            <div className="d-flex align-items-center">
                              <div className="star-rating star-rating-lg secondary me-4">
                                <div className="rating" style={{width: '35%'}} />
                              </div>
                              <span>32</span>
                            </div>
                          </div>
                          <div className="d-md-flex align-items-center my-3 my-md-4">
                            <div className="bg-gray-200 position-relative rounded-pill flex-grow-1 me-md-5 mb-2 mb-md-0 mw-md-260p" style={{height: '10px'}}>
                              <div className="bg-teal rounded-pill position-absolute top-0 left-0 bottom-0" style={{width: '15%'}} />
                            </div>
                            <div className="d-flex align-items-center">
                              <div className="star-rating star-rating-lg secondary me-4">
                                <div className="rating" style={{width: '15%'}} />
                              </div>
                              <span>1</span>
                            </div>
                          </div>
