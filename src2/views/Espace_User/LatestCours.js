                  ...
                  <div className="col-xl-8">
                    ...
                    <div className="card border shadow p-2 lift sk-fade mb-6 flex-md-row align-items-center row gx-0">
                      ...
                      <div className="col-md-4New card-zoom position-relative">
                        ...
                        <a href="course-single-v5.html" className="card-img sk-thumbnail img-ratio-2 d-block">
                      ...
                      <div className="col-md-8 card-footer px-2 px-md-5 py-4 py-md-0 position-relative">
                        ...
                        <div className="position-relative">
                          <a href="course-single-v5.html" className="d-block stretched-link"><h4 className="line-clamp-2 me-md-6 me-lg-10 me-xl-4 mb-3">The Complete JavaScript Course 2020: Build Real Projects!</h4></a>
                          ...
                          <div className="row mx-n2 align-items-center">
                            <div className="col px-2">
                              ...
                              <ins className="h4 mb-0 mb-lg-n1 ms-1">$415.99</ins>
                            </div>
                    ...
                    <div className="card border shadow p-2 lift sk-fade mb-6 flex-md-row align-items-center row gx-0">
                      ...
                      <div className="col-md-8 card-footer px-2 px-md-5 py-4 py-md-0 position-relative">
                        ...
                        {/* Heading */}
                        <div className="position-relative">
                          <a href="course-single-v5.html" className="d-block stretched-link"><h4 className="line-clamp-2 me-md-6 me-lg-10 me-xl-4 mb-3">Learn Figma: User Interface Design Essentials - UI/UX Design</h4></a>
                          <ul className="nav mx-n3 mb-3">
                            <li className="nav-item px-3">
                              <div className="d-flex align-items-center">
                                <div className="me-2 d-flex text-secondary icon-uxs">
                    ...
                    <div className="card border shadow p-2 lift sk-fade mb-6 flex-md-row align-items-center row gx-0">
                      ...
                      <div className="col-md-8 card-footer px-2 px-md-5 py-4 py-md-0 position-relative">
                        ...
                        {/* Heading */}
                        <div className="position-relative">
                          <a href="course-single-v5.html" className="d-block stretched-link"><h4 className="line-clamp-2 me-md-6 me-lg-10 me-xl-4 mb-3">Guide to Front-End Web Development and Design</h4></a>
                          <ul className="nav mx-n3 mb-3">
                            <li className="nav-item px-3">
                              <div className="d-flex align-items-center">
                                <div className="me-2 d-flex text-secondary icon-uxs">
                    ...
                    <div className="card border shadow p-2 lift sk-fade mb-6 flex-md-row align-items-center row gx-0">
                      ...
                      <div className="col-md-4New card-zoom position-relative">
                        ...
                        <a href="course-single-v5.html" className="card-img sk-thumbnail img-ratio-2 d-block">
                          <img className="rounded shadow-light-lg" src="../assets/img/products/product-24.jpg" alt="..." />
                        </a>
                        <span className="badge sk-fade-bottom badge-lg badge-orange badge-pill badge-float bottom-0 left-0 mb-4 ms-4">
                          <span className="text-white text-uppercase fw-bold font-size-xs">BEST SELLER</span>
                        </span>
