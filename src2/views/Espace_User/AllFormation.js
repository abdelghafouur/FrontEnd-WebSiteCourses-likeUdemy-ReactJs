          ...
          ================================================== */}
              <div className="container mb-6 mb-xl-8 z-index-2">
                <div className="d-lg-flex align-items-center mb-6 mb-xl-0 ffr">
                  <p className="mb-lg-0 ffr">We found <span className="text-dark">834 courses</span> available for you</p>
              ...
              <div className="container clrB">
                <div className="row">
                        ...
                        <div id="coursefiltercollapse1" className="collapse show mt-n2 px-6 pb-6" aria-labelledby="coursefilter1" data-parent="#courseSidebar">
                          <ul className="list-unstyled list-group list-checkbox">
                            <li className="custom-control custom-checkbox">
                              ...
                              <label className="custom-control-label font-size-base" htmlFor="categorycustomcheckone">Art (8)</label>
                            </li>
                            <li className="custom-control custom-checkbox">
                              <input type="checkbox" className="custom-control-input" id="categorycustomcheck2" />
                              <label className="custom-control-label font-size-base" htmlFor="categorycustomcheck2">Exercise (8)</label>
                            </li>
                            <li className="custom-control custom-checkbox">
                              <input type="checkbox" className="custom-control-input" id="categorycustomcheck3" />
                              <label className="custom-control-label font-size-base" htmlFor="categorycustomcheck3">Material Design (7)</label>
                            </li>
                            <li className="custom-control custom-checkbox">
                              <input type="checkbox" className="custom-control-input" id="categorycustomcheck4" />
                              <label className="custom-control-label font-size-base" htmlFor="categorycustomcheck4">Software Development (6)</label>
                            </li>
                            <li className="custom-control custom-checkbox">
                              <input type="checkbox" className="custom-control-input" id="categorycustomcheck5" />
                              <label className="custom-control-label font-size-base" htmlFor="categorycustomcheck5">Music (6)</label>
                            </li>
                            <li className="custom-control custom-checkbox">
                              <input type="checkbox" className="custom-control-input" id="categorycustomcheck6" />
                              <label className="custom-control-label font-size-base" htmlFor="categorycustomcheck6">Photography (6)</label>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div id="coursefiltercollapse3" className="collapse show mt-n2 px-6 pb-6" aria-labelledby="coursefilter3" data-parent="#courseSidebar">
                          <ul className="list-unstyled list-group list-checkbox">
                            <li className="custom-control custom-radio">
                              ...
                              <label className="custom-control-label font-size-base" htmlFor="pricecustomradio1">All (18)</label>
                            </li>
                            <li className="custom-control custom-radio">
                          ...
                          <ul className="list-unstyled list-group list-checkbox">
                              ...
                              <label className="custom-control-label font-size-base" htmlFor="ratingcustomcheck1">
                                <span className="d-flex align-items-end">
                                  <span className="star-rating">
                                    <span className="rating" style={{width: '90%'}} />
                                  </span>
                                  <span className="ms-3">
                                    <span>&amp; up</span>
                                  </span>
                            ...
                            <li className="custom-control custom-checkbox">
                              ...
                              <label className="custom-control-label font-size-base" htmlFor="ratingcustomcheck2">
                                <span className="d-flex align-items-end">
                                  <span className="star-rating">
                                    <span className="rating" style={{width: '70%'}} />
                                  </span>
                                  <span className="ms-3">
                                    <span>&amp; up</span>
                                  </span>
                            ...
                            <li className="custom-control custom-checkbox">
                              ...
                              <label className="custom-control-label font-size-base" htmlFor="ratingcustomcheck3">
                                <span className="d-flex align-items-end">
                                  <span className="star-rating">
                                    <span className="rating" style={{width: '50%'}} />
                                  </span>
                                  <span className="ms-3">
                                    <span>&amp; up</span>
                                  </span>
                            ...
                            <li className="custom-control custom-checkbox">
                              ...
                              <label className="custom-control-label font-size-base" htmlFor="ratingcustomcheck4">
                                <span className="d-flex align-items-end">
                                  <span className="star-rating">
                                    <span className="rating" style={{width: '35%'}} />
                                  </span>
                                  <span className="ms-3">
                                    <span>&amp; up</span>
                                  </span>
                            ...
                            <li className="custom-control custom-checkbox">
                              ...
                              <label className="custom-control-label font-size-base" htmlFor="ratingcustomcheck5">
                                <span className="d-flex align-items-end">
                                  <span className="star-rating">
                                    <span className="rating" style={{width: '10%'}} />
                                  </span>
                                  <span className="ms-3">
                                    <span>&amp; up</span>
                                  </span>
                  ...
                  <div className="col-xl-8">
                    {/* Card */}
                    <div className="col-xl mb-5 mb-md-6">
              {/* Card */}
              <div className="card border shadow p-2 lift">
                <div className="row gx-0 align-items-center">
                  ...
                  <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth: '120px'}}>
                    <img className="img-fluid rounded shadow-light-lg h-100 h-md-auto o-f-c" src="../assets/img/events/event-1.jpg" alt="..." />
                  </a>
                  {/* Body */}
                  <div className="col">
                    <div className="card-body py-0 px-md-5 px-3">
                      <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52">Elegant Light Box Paper Cut Dioramas New Design Conference</h5></a>
                  ...
                  <a href="event-single.html" className="col-auto rounded-lg d-none d-md-flex w-100p h-100p place-center bg-dark me-5">
                    <div className="w-100 text-center">
                      <h3 className="text-white mb-0 fw-semi-bold font-size-xxl">06</h3>
                      <span className="h4 mb-0 text-white fw-normal">April</span>
                    </div>
                  </a>
                </div>
              </div>
            ...
            <div className="col-xl mb-5 mb-md-6">
              ...
              <div className="card border shadow p-2 lift">
                <div className="row gx-0 align-items-center">
                  {/* Image */}
                  <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth: '120px'}}>
                    <img className="img-fluid rounded shadow-light-lg h-100 h-md-auto o-f-c" src="../assets/img/events/event-2.jpg" alt="..." />
                  </a>
                  {/* Body */}
                  <div className="col">
                    <div className="card-body py-0 px-md-5 px-3">
                      <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52">Lambeth Safeguarding: Understanding Contextual Harm</h5></a>
                      <ul className="nav mx-n3 d-block d-md-flex">
                        <li className="nav-item px-3 mb-3 mb-md-0">
                          <div className="d-flex align-items-center">
                            <div className="me-2 d-flex text-secondary icon-uxs">
            ...
            <div className="col-xl mb-5 mb-md-6">
              ...
              <div className="card border shadow p-2 lift">
                <div className="row gx-0 align-items-center">
                  {/* Image */}
                  <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth: '120px'}}>
                    <img className="img-fluid rounded shadow-light-lg h-100 h-md-auto o-f-c" src="../assets/img/events/event-3.jpg" alt="..." />
                  </a>
                  {/* Body */}
                  <div className="col">
                    <div className="card-body py-0 px-md-5 px-3">
                      <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52">Discover Law - Get into the best UK law schools</h5></a>
                      <ul className="nav mx-n3 d-block d-md-flex">
                        <li className="nav-item px-3 mb-3 mb-md-0">
                          <div className="d-flex align-items-center">
                            <div className="me-2 d-flex text-secondary icon-uxs">
            ...
            <div className="col-xl mb-5 mb-md-6">
              ...
              <div className="card border shadow p-2 lift">
                <div className="row gx-0 align-items-center">
                  {/* Image */}
                  <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth: '120px'}}>
                    <img className="img-fluid rounded shadow-light-lg h-100 h-md-auto o-f-c" src="../assets/img/events/event-4.jpg" alt="..." />
                  </a>
                  {/* Body */}
                  <div className="col">
                    <div className="card-body py-0 px-md-5 px-3">
                      <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52">Undergraduate Open Day – Holloway Campus - 3 July 2020</h5></a>
                      <ul className="nav mx-n3 d-block d-md-flex">
                        <li className="nav-item px-3 mb-3 mb-md-0">
                          <div className="d-flex align-items-center">
                            <div className="me-2 d-flex text-secondary icon-uxs">
            ...
            <div className="col-xl mb-5 mb-md-6">
              ...
              <div className="card border shadow p-2 lift">
                <div className="row gx-0 align-items-center">
                  {/* Image */}
                  <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth: '120px'}}>
                    <img className="img-fluid rounded shadow-light-lg h-100 h-md-auto o-f-c" src="../assets/img/events/event-5.jpg" alt="..." />
                  </a>
                  {/* Body */}
                  <div className="col">
                    <div className="card-body py-0 px-md-5 px-3">
                      <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52">"Introduction to Law" Open Day with Bristows</h5></a>
                      <ul className="nav mx-n3 d-block d-md-flex">
                        <li className="nav-item px-3 mb-3 mb-md-0">
                          <div className="d-flex align-items-center">
                            <div className="me-2 d-flex text-secondary icon-uxs">
            ...
            <div className="col-xl mb-5 mb-md-6">
              ...
              <div className="card border shadow p-2 lift">
                <div className="row gx-0 align-items-center">
                  {/* Image */}
                  <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth: '120px'}}>
                    <img className="img-fluid rounded shadow-light-lg h-100 h-md-auto o-f-c" src="../assets/img/events/event-6.jpg" alt="..." />
                  </a>
                  {/* Body */}
                  <div className="col">
                    <div className="card-body py-0 px-md-5 px-3">
                      <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52">Kingston College undergraduate Open Events 2019-20</h5></a>
                      <ul className="nav mx-n3 d-block d-md-flex">
                        <li className="nav-item px-3 mb-3 mb-md-0">
                          <div className="d-flex align-items-center">
                            <div className="me-2 d-flex text-secondary icon-uxs">
                      ...
                      <ul className="pagination justify-content-center">
                        <li className="page-item">
                          <a className="page-link" href="#" aria-label="Previous">
                            <span aria-hidden="true"><i className="fas fa-arrow-left" /></span>
                          </a>
                        </li>
                        ...
                        <li className="page-item">
                          <a className="page-link" href="#" aria-label="Next">
                            <span aria-hidden="true"><i className="fas fa-arrow-right" /></span>
                          </a>
                        </li>
                      </ul>
                    </nav>
