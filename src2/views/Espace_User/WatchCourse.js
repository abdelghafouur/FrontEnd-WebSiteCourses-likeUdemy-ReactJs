...
const videos = [
  'https://www.youtube.com/watch?v=9I-Y6VQ6tyI',
  'https://www.youtube.com/watch?v=Qc7_zRjH808&ab_channel=FIFTYFIFTYOfficial'
...
const WatchCourse = () => { 
 ...
 <div className="h-60p w-60p rounded-circle bg-white size-20-all d-inline-flex align-items-center justify-content-center position-absolute center z-index-1">
                      ...
                      <img className="rounded shadow-light-lg" src="../assets/img/products/product-23.jpg" alt="..." />
        </a>
      ))}
                  ...
                  <h3 className="text-white mb-6">Comment</h3>
                  <ul className="list-unstyled pt-2">
                      ...
                      <div className="media-body flex-grow-1">
                        <div className="d-md-flex align-items-center mb-5">
                          <div className="me-auto mb-4 mb-md-0">
                            <h5 className="text-white mb-0">Oscar Cafeo</h5>
                    ...
                    <li className="media d-flex">
                      ...
                      <div className="media-body flex-grow-1">
                        <div className="d-md-flex align-items-center mb-5">
                          <div className="me-auto mb-4 mb-md-0">
                            <h5 className="text-white mb-0">Alex Morgan</h5>
                            <p className="font-size-sm font-italic">Beautiful courses</p>
                          </div>
                  ...
                  <div className="bg-portgore rounded p-6 p-md-9 mb-8">
                    <h3 className="text-white mb-2">Add Reviews &amp; Rate</h3>
                    ...
                    <form>
                      ...
                      <div className="form-group mb-6">
                        <label className="text-white" htmlFor="exampleInputTitle1">Review Title</label>
                        <input type="text" className="form-control placeholder-1 bg-dark border-0" id="exampleInputTitle1" placeholder="Courses" />
                      </div>
                      <div className="form-group mb-6">
                        <label className="text-white" htmlFor="exampleFormControlTextarea1">Review Content</label>
                        <textarea className="form-control placeholder-1 bg-dark border-0" id="exampleFormControlTextarea1" rows={6} placeholder="Content" defaultValue={""} />
                      </div>
                      <button type="submit" className="btn btn-orange btn-block mw-md-300p">SUBMIT REVIEW</button>
                    </form>
                  </div>
                    ...
                    <form className="mb-5">
                      <div className="input-group rounded">
                        <div className="input-group-prepend">
                          <button className="btn btn-sm text-secondary bg-dark" type="submit">
                            {/* Icon */}
                        ...
                        <input className="form-control form-control-sm border-0 ps-0 bg-dark" type="search" placeholder="Search item" aria-label="Search" />
                      </div>
                    </form>
                    <div id="accordionCurriculum" className>
                        ...
                        <div id="CurriculumcollapseOne" className="collapse show" aria-labelledby="curriculumheadingOne" data-parent="#accordionCurriculum">
                          <div className="border-top px-5 border-color-20 py-4 min-height-70 d-md-flex align-items-center">
                            ...
                            <div className="d-flex align-items-center overflow-auto overflow-md-visible flex-shrink-all">
                              <div className="badge btn-orange-soft text-white-70 me-5 font-size-sm fw-normal py-2">30 min</div>
                      ...
                      <div className="overflow-hidden bg-dark rounded mb-6">
                        <div className="d-flex align-items-center" id="curriculumheadingTwo">
                          <h5 className="mb-0 w-100">
                            <button className="d-flex align-items-center p-5 min-height-80 text-white fw-medium collapse-accordion-toggle line-height-one" type="button" data-bs-toggle="collapse" data-bs-target="#CurriculumcollapseTwo" aria-expanded="true" aria-controls="CurriculumcollapseTwo">
                              <span className="me-4 text-white d-flex">
                                {/* Icon */}
                                <svg width={15} height={2} viewBox="0 0 15 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect width={15} height={2} fill="currentColor" />
                        ...
                        <div id="CurriculumcollapseTwo" className="collapse show" aria-labelledby="curriculumheadingTwo" data-parent="#accordionCurriculum">
                          ...
                          <div className="border-top px-5 border-color-20 py-4 min-height-70 d-md-flex align-items-center">
                            ...
                            <div className="d-flex align-items-center overflow-auto overflow-md-visible flex-shrink-all">
                              <div className="badge btn-orange-soft text-white-70 me-5 font-size-sm fw-normal py-2">45 min</div>
                              <div className="text-secondary d-flex">
                                {/* Icon */}
                                <svg width={20} height={20} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M15.625 7.34375H7.3423V4.13164C7.3423 2.715 8.53391 1.5625 9.99855 1.5625C11.4632 1.5625 12.6548 2.715 12.6548 4.13164V5.625H14.2173V4.13164C14.2173 1.85344 12.3248 0 9.99855 0C7.67234 0 5.7798 1.85344 5.7798 4.13164V7.34375H4.375C3.08266 7.34375 2.03125 8.39516 2.03125 9.6875V17.6562C2.03125 18.9486 3.08266 20 4.375 20H15.625C16.9173 20 17.9688 18.9486 17.9688 17.6562V9.6875C17.9688 8.39516 16.9173 7.34375 15.625 7.34375ZM16.4062 17.6562C16.4062 18.087 16.0558 18.4375 15.625 18.4375H4.375C3.94422 18.4375 3.59375 18.087 3.59375 17.6562V9.6875C3.59375 9.25672 3.94422 8.90625 4.375 8.90625H15.625C16.0558 8.90625 16.4062 9.25672 16.4062 9.6875V17.6562Z" fill="currentColor" />
                          ...
                          <div className="border-top px-5 border-color-20 py-4 min-height-70 d-md-flex align-items-center">
                            ...
                            <div className="d-flex align-items-center overflow-auto overflow-md-visible flex-shrink-all">
                              <button className="btn btn-sm btn-orange-soft text-white-70 me-5 font-size-sm fw-normal py-1">30 min</button>
                              <a href="#" className="text-secondary">
                                {/* Icon */}
                                <svg width={14} height={16} viewBox="0 0 14 16" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M12.8704 6.15374L3.42038 0.328572C2.73669 -0.0923355 1.9101 -0.109836 1.20919 0.281759C0.508282 0.673291 0.0898438 1.38645 0.0898438 2.18929V13.7866C0.0898438 15.0005 1.06797 15.9934 2.27016 16C2.27344 16 2.27672 16 2.27994 16C2.65563 16 3.04713 15.8822 3.41279 15.6591C3.70694 15.4796 3.79991 15.0957 3.62044 14.8016C3.44098 14.5074 3.05697 14.4144 2.76291 14.5939C2.59188 14.6982 2.42485 14.7522 2.27688 14.7522C1.82328 14.7497 1.33763 14.3611 1.33763 13.7866V2.18933C1.33763 1.84492 1.51713 1.53907 1.81775 1.3711C2.11841 1.20314 2.47294 1.21064 2.76585 1.39098L12.2159 7.21615C12.4999 7.39102 12.6625 7.68262 12.6618 8.01618C12.6611 8.34971 12.4974 8.64065 12.2118 8.81493L5.37935 12.9983C5.08548 13.1783 4.9931 13.5623 5.17304 13.8562C5.35295 14.1501 5.73704 14.2424 6.03092 14.0625L12.8625 9.87962C13.5166 9.48059 13.9081 8.78496 13.9096 8.01868C13.9112 7.25249 13.5226 6.55524 12.8704 6.15374Z" fill="currentColor" />
                      ...
                      <div className="overflow-hidden bg-dark rounded mb-6">
                        <div className="d-flex align-items-center" id="curriculumheadingThree">
                          <h5 className="mb-0 w-100">
                            <button className="d-flex align-items-center p-5 min-height-80 text-white fw-medium collapse-accordion-toggle line-height-one" type="button" data-bs-toggle="collapse" data-bs-target="#CurriculumcollapseThree" aria-expanded="true" aria-controls="CurriculumcollapseThree">
                              <span className="me-4 text-white d-flex">
                                {/* Icon */}
                                <svg width={15} height={2} viewBox="0 0 15 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect width={15} height={2} fill="currentColor" />
                        ...
                        <div id="CurriculumcollapseThree" className="collapse show" aria-labelledby="curriculumheadingThree" data-parent="#accordionCurriculum">
                          <div className="border-top px-5 border-color-20 py-4 min-height-70 d-md-flex align-items-center">
                            <div className="d-flex align-items-center me-auto mb-4 mb-md-0">
                              <div className="text-secondary d-flex">
                                <svg width={14} height={18} viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="overflow-hidden bg-dark rounded mb-6">
                        <div className="d-flex align-items-center" id="curriculumheadingFour">
                          <h5 className="mb-0 w-100">
                            <button className="d-flex align-items-center p-5 min-height-80 text-white fw-medium collapse-accordion-toggle line-height-one" type="button" data-bs-toggle="collapse" data-bs-target="#CurriculumcollapseFour" aria-expanded="true" aria-controls="CurriculumcollapseFour">
                              <span className="me-4 text-white d-flex">
                                {/* Icon */}
                                <svg width={15} height={2} viewBox="0 0 15 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect width={15} height={2} fill="currentColor" />
                        ...
                        <div id="CurriculumcollapseFour" className="collapse show" aria-labelledby="curriculumheadingFour" data-parent="#accordionCurriculum">
                          <div className="border-top px-5 border-color-20 py-4 min-height-70 d-md-flex align-items-center">
                            <div className="d-flex align-items-center me-auto mb-4 mb-md-0">
                              <div className="text-secondary d-flex">
                                <svg width={14} height={18} viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
