  ...
  return (
          ...
          ================================================== */}
              <header className="py-8 py-md-11" style={{backgroundImage: 'none'}}>
                <div className="container text-center py-xl-2">
                  <h1 className="display-4 fw-semi-bold mb-0">My Courses</h1>
                </div>
              </header>
              {/* CONTROL BAR
          ================================================== */}
              <div className="container mb-6 mb-xl-8 z-index-2">
                <div className="d-xl-flex align-items-center ffr">
                  <p className="mb-xl-0 ffr">We found <span className="text-dark">834 courses</span> available for you</p>
                  <div className="ms-xl-auto d-xl-flex flex-wrap">
                    <div className="mb-4 mb-xl-0 ms-xl-6 cls-Sel ffr">
          ...
          ================================================== */}
              <div className="container pb-4 pb-xl-7 clrB">
                <div className="row row-cols-md-2 row-cols-xl-3 mb-6 mb-xl-3">
                    ...
                    <div className="card border shadow p-2 lift sk-fade">
                      ...
                      <div className="card-zoom position-relative">
                        <div className="badge-float sk-fade-top top-0 right-0 mt-4 me-4">
                          <a href="course-single-v2.html" className="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 me-1 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                            {/* Icon */}
                          ...
                          <a href="course-single-v2.html" className="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                            {/* Icon */}
                        ...
                        <a href="course-single-v2.html" className="card-img sk-thumbnail d-block">
                      ...
                      <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        {/* Preheading */}
                        <a href="course-single-v2.html"><span className="mb-1 d-inline-block text-gray-800">Photography</span></a>
                        {/* Heading */}
                        <div className="position-relative">
                          <a href="course-single-v2.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Fashion Photography From Professional</h4></a>
                          <div className="d-lg-flex align-items-end flex-wrap mb-n1">
                            <div className="star-rating mb-2 mb-lg-0 me-lg-3">
                              <div className="rating" style={{width: '50%'}} />
                            </div>
                  ...
                  <div className="col-md pb-4 pb-md-7">
                    ...
                    <div className="card border shadow p-2 lift sk-fade">
                      ...
                      <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        {/* Preheading */}
                        <a href="course-single-v2.html"><span className="mb-1 d-inline-block text-gray-800">Development</span></a>
                        {/* Heading */}
                        <div className="position-relative">
                          <a href="course-single-v2.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">The Complete JavaScript Course 2020: Build Real Projects!</h4></a>
                          <div className="d-lg-flex align-items-end flex-wrap mb-n1">
                            <div className="star-rating mb-2 mb-lg-0 me-lg-3">
                              <div className="rating" style={{width: '50%'}} />
                            </div>
                  ...
                  <div className="col-md pb-4 pb-md-7">
                    ...
                    <div className="card border shadow p-2 lift sk-fade">
                      ...
                      <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        {/* Heading */}
                        <div className="position-relative">
                          <a href="course-single-v2.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Learn Figma: User Interface Design Essentials - UI/UX Design</h4></a>
                          <div className="d-lg-flex align-items-end flex-wrap mb-n1">
                            <div className="star-rating mb-2 mb-lg-0 me-lg-3">
                              <div className="rating" style={{width: '50%'}} />
                            </div>
                  ...
                  <div className="col-md pb-4 pb-md-7">
                    ...
                    <div className="card border shadow p-2 lift sk-fade">
                      ...
                      <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        {/* Heading */}
                        <div className="position-relative">
                          <a href="course-single-v2.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">The Complete Financial Analyst Course 2020</h4></a>
                          <div className="d-lg-flex align-items-end flex-wrap mb-n1">
                            <div className="star-rating mb-2 mb-lg-0 me-lg-3">
                              <div className="rating" style={{width: '50%'}} />
                            </div>
                  ...
                  <div className="col-md pb-4 pb-md-7">
                    ...
                    <div className="card border shadow p-2 lift sk-fade">
                      ...
                      <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        {/* Heading */}
                        <div className="position-relative">
                          <a href="course-single-v2.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Unity Medical Visualization: 03 Deployment and Usability</h4></a>
                          <div className="d-lg-flex align-items-end flex-wrap mb-n1">
                            <div className="star-rating mb-2 mb-lg-0 me-lg-3">
                              <div className="rating" style={{width: '50%'}} />
                            </div>
                  ...
                  <div className="col-md pb-4 pb-md-7">
                    ...
                    <div className="card border shadow p-2 lift sk-fade">
                      ...
                      <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        {/* Heading */}
                        <div className="position-relative">
                          <a href="course-single-v2.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Cubase Pro 10 Essential Training: Advanced</h4></a>
                          <div className="d-lg-flex align-items-end flex-wrap mb-n1">
                            <div className="star-rating mb-2 mb-lg-0 me-lg-3">
                              <div className="rating" style={{width: '50%'}} />
                            </div>
                  ...
                  <div className="col-md pb-4 pb-md-7">
                    ...
                    <div className="card border shadow p-2 lift sk-fade">
                      ...
                      <div className="card-zoom position-relative">
                        <a href="course-single-v2.html" className="card-img sk-thumbnail d-block">
                          <img className="rounded shadow-light-lg" src="../assets/img/products/product-22.jpg" alt="..." />
                        </a>
                        <span className="badge sk-fade-bottom badge-lg badge-purple badge-pill badge-float bottom-0 left-0 mb-4 ms-4">
                          <span className="text-white text-uppercase fw-bold font-size-xs">Featured</span>
                        </span>
                      ...
                      <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        {/* Heading */}
                        <div className="position-relative">
                          <a href="course-single-v2.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">QuickBooks Online Essential Training </h4></a>
                          <div className="d-lg-flex align-items-end flex-wrap mb-n1">
                            <div className="star-rating mb-2 mb-lg-0 me-lg-3">
                              <div className="rating" style={{width: '50%'}} />
                            </div>
                ...
                <div id="loadcollapseExample" className="collapse row row-cols-md-2 row-cols-xl-3 mb-6 mb-xl-3">
                  <div className="col-md pb-4 pb-md-7">
                    {/* Card */}
                    <div className="card border shadow p-2 lift sk-fade">
                      {/* Image */}
