...
const MyCoures = () => {
  ...
  const fetchUserCourses = async () => {
    try {
      const response = await axios.get(`http://127.0.0.1:8000/api/user/${userInformation?.id}/courses`, {
        params: {
          page: currentPage,
                  ...
                  <div className="ms-xl-auto d-xl-flex flex-wrap">
                    <div className="mb-4 mb-xl-0 ms-xl-6 cls-Sel ffr">
                      <div className="border rounded d-flex align-items-center choices-label h-50p">
                        ...
                        data-choices
                        value={filter}
                        onChange={handleFilterChange} // Add the change event handler
                      >
                  ...
                  <div className="col-md pb-4 pb-md-7" key={course.id}>
                    ...
                    <div className="card border shadow p-2 lift sk-fade">
                      ...
                      <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        {/* Preheading */}
                        <a href="course-single-v2.html"><span className="mb-1 d-inline-block text-gray-800">{course.course.category.name}</span></a>
                        {/* Heading */}
                        <div className="position-relative">
                          <a href="course-single-v2.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">{course.course.title}</h4></a>
                              ...
                              <ul className="nav mx-n3">
                                <li className="nav-item px-3">
                                  <div className="d-flex align-items-center">
                                    ...
                                    <div className="font-size-sm">{course.course.lessons} lessons</div>
                                  </div>
                                </li>
                                <li className="nav-item px-3">
                                  <div className="d-flex align-items-center">
                                    ...
                                    <div className="font-size-sm">{course.course.duration}</div>
                                  </div>
                                </li>
                              </ul>
                            </div>
                            <div className="col-auto px-2 text-right">
                              <ins className="h4 mb-0 d-block mb-lg-n1">${course.course.price}</ins>
                            </div>
                          </div>
                        </div>
                      </div>
