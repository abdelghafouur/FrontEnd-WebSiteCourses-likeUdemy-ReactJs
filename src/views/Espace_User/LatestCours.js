                  ...
                  <div className="col-xl-8">
                    ...
                    <div key={course.id} className="card border shadow p-2 lift sk-fade mb-6 flex-md-row align-items-center row gx-0">
                      ...
                      <div className="col-md-8 card-footer px-2 px-md-5 py-4 py-md-0 position-relative">
                        {/* Preheading */}
                        <a href="course-single-v5.html" style={{"marginLeft":"10px"}}><span className="mb-1 d-inline-block text-gray-800">{course.category.name}</span></a> 
                        <a href="course-single-v5.html" style={{"marginLeft":"50px"}}><span className="mb-1 d-inline-block text-gray-800">{course.date}</span></a>
                        {/* Heading */}
